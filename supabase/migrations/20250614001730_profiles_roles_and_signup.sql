...
-- Исходная версия обращалась к таблицам старой схемы (projects, audits, analytics), которые
...
-- Функция для updated_at (раньше создавалась только в следующей миграции)
