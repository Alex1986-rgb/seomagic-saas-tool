...
// Must be rendered inside a parent <Tabs> (see PositionTracker.tsx). It only
// renders the tab triggers; the matching <TabsContent> lives in TrackerContent
// under the same <Tabs> provider.
