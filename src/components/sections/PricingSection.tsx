  ...
  <section className="py-16 overflow-hidden relative">
    ...
    <div className="container mx-auto px-4 md:px-6">
      <div className="text-center mb-12">
        ...
        >
          <span className="font-bold">SEO аудит всех страниц сайта - БЕСПЛАТНО!</span> Мы адаптируем стоимость услуг под размер вашего проекта. Платите только за то, что действительно нужно оптимизировать.
        </motion.p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
        <PricingCard 
          ...
          features={[
            "150₽ за базовую оптимизацию страницы (разовый платёж)",
