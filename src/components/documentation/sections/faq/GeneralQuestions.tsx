...
export const generalQuestionsData = [
  {
    question: "Что такое глубокий анализ сайта?",
    answer: "Глубокий анализ - это комплексное сканирование всех страниц сайта, которое включает: Проверку структуры сайта, Анализ контента на уникальность, Поиск битых ссылок, Проверку мета-тегов, Анализ скорости загрузки, Составление подробной сметы на исправление."
  },
  {
    question: "Сколько времени занимает глубокий анализ?",
    answer: "Время анализа зависит от размера сайта: До 100 страниц: 5-15 минут, 100-1000 страниц: 15-30 минут, Более 1000 страниц: от 30 минут."
  }
];
