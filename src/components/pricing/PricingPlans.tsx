  ...
  const plans = [
    ...
    },
    {
      ...
      features: [
        ...
        'Поиск битых ссылок',
        'Анализ дубликатов страниц',
        'Полная генерация sitemap',
        'Email поддержка',
      ],
      restrictions: [],
      recommended: false,
    ...
    },
    {
      ...
      features: [
        ...
        '500 запросов для проверки позиций',
        'Поиск битых ссылок и редиректов',
        'Анализ дубликатов и дублей контента',
        'Расширенная генерация sitemap',
    ...
    },
    {
      ...
      features: [
        ...
        'Неограниченная проверка позиций',
        'Расширенная проверка ссылок и редиректов',
        'Глубокий анализ дубликатов контента',
        'Расширенная генерация sitemap',
        'Визуализация структуры и связей',
        'Расчет PageRank с настройками',
        'Проверка уникальности с отчетом',
