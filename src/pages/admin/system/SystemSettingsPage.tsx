...
const SystemSettingsPage: React.FC = () => {
  ...
  return (
    <div className="p-4 md:p-8 space-y-8 max-w-4xl mx-auto">
      <PageSeo
        title="Системные настройки: базовые параметры работы платформы"
        description="Общие технические параметры сервиса и переходы к разделам базы данных, безопасности, почты, логирования и резервных копий."
        noindex
      />
