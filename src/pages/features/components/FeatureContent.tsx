        ...
        <CardContent className="p-6">
          ...
          <Accordion type="single" collapsible className="mt-8">
            ...
            <AccordionItem value="faq-2">
              ...
              <AccordionContent>
                {/* Здесь были «значительное улучшение через 2-4 недели» и «рост трафика
                    на 35-50% за три месяца» у «большинства клиентов» — таких замеров нет. */}
                Сервис показывает ошибки и готовит исправления. Как изменятся позиции после 
                правок, зависит от сайта и конкуренции в нише, поэтому конкретный рост мы не обещаем.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </CardContent>
