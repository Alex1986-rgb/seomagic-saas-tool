        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              Manage your SEO audits and optimized sites
            </p>
          </div>
            ...
            <div className="md:col-span-3">
              ...
              {activeTab === 'sites' && (
                <div className="glass-panel p-8 text-center">
                  ...
                  <h3 className="text-xl font-semibold mb-2">No Optimized Sites Yet</h3>
                  <p className="text-muted-foreground mb-6">
                    After completing an audit, you can generate an optimized version of your site.
                  </p>
