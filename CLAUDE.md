...
- **Аудит сайта — реальная функциональность.** Трекинг позиций и «автоматическая оптимизация» — моки/демо-данные, выдающие себя за рабочие фичи.
- Исправления и разбор — PR #2; перевод ИИ-функций на Anthropic API — ветка `feat/anthropic-ai` (PR #3).
